...
const FeatureCards = () => {
  ...
  <div className="features-container">
    ...
    <div className="features-header">
      <h3 className="features-title">Boost productivity, together.</h3>
      <p className="features-subtitle">Everything you need to stay organized and work better as a team</p>
    </div>

    {/* Optional: background spotlight */}
    ...
    <div className="bento-grid" ref={gridRef}>
      ...
      <ParticleCard className="feature-card card1" disableAnimations={isMobile}>
        <div className="messages-gif-wrapper">
          <img src="/assets/teamwork.gif" alt="Teamwork animation" className="messages-gif" />
        </div>
        <h2>{isMobile ? "100" : <CountUp to={100} />}%</h2>
        <h3>Team Collaboration</h3>
        <p>Stay connected and aligned on every task and project.</p>
      </ParticleCard>

      {/* Feature 2: Task Management */}
      <ParticleCard className="feature-card card2" disableAnimations={isMobile}>
        <div className="components-gif-wrapper">
          <img src="/assets/tasks.gif" alt="Task management animation" className="components-gif" />
        </div>
        <h2>{isMobile ? "50" : <CountUp to={1000} />}+</h2>
        <h3>Tasks & Projects</h3>
        <p>Manage tasks, set deadlines, and track progress with ease.</p>
      </ParticleCard>
      ...
      <ParticleCard className="feature-card card4" disableAnimations={isMobile}>
        <div className="switch-gif-wrapper">
          {/* <img src="/assets/customize.gif" alt="Customization" className="switch-gif" /> */}
        </div>
        <h2>{isMobile ? "2" : <CountUp to={2} />}</h2>
        <h3>Custom Views</h3>
        <p>Switch between list or board views effortlessly to suit your workflow.</p>
      </ParticleCard>
